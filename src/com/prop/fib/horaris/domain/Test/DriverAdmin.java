...
public class DriverAdmin {
    ...
    private void  mostrarMenu() throws Exception{
        sc.writeln("--------------------------------------------------------------------\n");
        sc.writeln("-                    DRIVERS ADMIN                                 -\n");
        sc.writeln("-           [opcio   Operacio(Atributs)                            -\n");
        sc.writeln("--------------------------------------------------------------------\n");
        sc.writeln("-                                                                  -\n");
        sc.writeln("-   0  Sortir DriverAdmin                                          -\n");
        sc.writeln("-   1  TestAdmin(String nom, String id, String pass)               -\n");
    ...
    public static void TestUser(inout sc) {
        try {
            ...
            a = new Admin(id,nom, password);
            sc.writeln("Admin entrada correctament");
        } catch (Exception e) {
            System.out.print(e);
        }
    }
